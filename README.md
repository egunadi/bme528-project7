# BME528 Project 7: Development of Preprocessing Algorithms for Integration into an End-to-End System for Feature Detection of Anterior Segment Optical Coherence Tomography (AS-OCT) Images

https://github.com/egunadi/bme528-project7
...
Results can be reproduced via "code/main.py", which dewarps all ten sample images in "images/original" and saves the dewarped images in "images/python_dewarped". 

Refraction correction or dewarping is done with OCT_Dewarp_BL, which works by running the following subroutines in the order listed:

- OCT_OuterCornea / OCT_InnerCornea: conduct basic image segmentation to detect cornea borders.
- OuterDewarp / InnerDewarp: perform the actual dewarping of the original image.
